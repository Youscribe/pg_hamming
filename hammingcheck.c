...
Datum hammingcheck(PG_FUNCTION_ARGS);
PG_FUNCTION_INFO_V1(hammingcheck);
Datum hammingcheck(PG_FUNCTION_ARGS) {
  int16 n = PG_GETARG_INT16(0);
  int16 r = PG_GETARG_INT16(3);
  int16 dist = 0;
  int i;
  ...
  array1 = PG_GETARG_ARRAYTYPE_P(1);
  array2 = PG_GETARG_ARRAYTYPE_P(2);
...
&arrayContent2, &arrayNullFlags2, &arrayLength2);
  ...
  for (i = 0; i < n; ++i)
  {
      int16 a = arrayContent1[i];
      int16 b = arrayContent2[i];

      if(((0x1 & a) & b) != (0x1 & a)) ++dist;
      if(((0x2 & a) & b) != (0x2 & a)) ++dist;
      if(((0x4 & a) & b) != (0x4 & a)) ++dist;
      if(((0x8 & a) & b) != (0x8 & a)) ++dist;
      if(((0x10 & a) & b) != (0x10 & a)) ++dist;
      if(((0x20 & a) & b) != (0x20 & a)) ++dist;
      if(((0x40 & a) & b) != (0x40 & a)) ++dist;
      if(((0x80 & a) & b) != (0x80 & a)) ++dist;

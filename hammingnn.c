...
Datum hammingnn(PG_FUNCTION_ARGS) {
    short c[9] = {1,9,37,93,163,219,247,255,256};
	...
	values[i++] = q^(0x7^0xFF);
	values[i++] = q^(0xB^0xFF);
	values[i++] = q^(0x13^0xFF);
	values[i++] = q^(0x23^0xFF);
	values[i++] = q^(0x43^0xFF);
	values[i++] = q^(0x83^0xFF);
	values[i++] = q^(0xD^0xFF);
	values[i++] = q^(0x15^0xFF);
	values[i++] = q^(0x25^0xFF);
	values[i++] = q^(0x45^0xFF);
	values[i++] = q^(0x85^0xFF);
	values[i++] = q^(0x19^0xFF);
	values[i++] = q^(0x29^0xFF);
	values[i++] = q^(0x49^0xFF);
	values[i++] = q^(0x89^0xFF);
	values[i++] = q^(0x31^0xFF);
	values[i++] = q^(0x51^0xFF);
	values[i++] = q^(0x91^0xFF);
	values[i++] = q^(0x61^0xFF);
	values[i++] = q^(0xA1^0xFF);
	values[i++] = q^(0xC1^0xFF);
	values[i++] = q^(0xE^0xFF);
	values[i++] = q^(0x16^0xFF);
	values[i++] = q^(0x26^0xFF);
	values[i++] = q^(0x46^0xFF);
	values[i++] = q^(0x86^0xFF);
	values[i++] = q^(0x1A^0xFF);
	values[i++] = q^(0x2A^0xFF);
	values[i++] = q^(0x4A^0xFF);
	values[i++] = q^(0x8A^0xFF);
	values[i++] = q^(0x32^0xFF);
	values[i++] = q^(0x52^0xFF);
	values[i++] = q^(0x92^0xFF);
	values[i++] = q^(0x62^0xFF);
	values[i++] = q^(0xA2^0xFF);
	values[i++] = q^(0xC2^0xFF);
	values[i++] = q^(0x1C^0xFF);
	values[i++] = q^(0x2C^0xFF);
	values[i++] = q^(0x4C^0xFF);
	values[i++] = q^(0x8C^0xFF);
	values[i++] = q^(0x34^0xFF);
	values[i++] = q^(0x54^0xFF);
	values[i++] = q^(0x94^0xFF);
	values[i++] = q^(0x64^0xFF);
	values[i++] = q^(0xA4^0xFF);
	values[i++] = q^(0xC4^0xFF);
	values[i++] = q^(0x38^0xFF);
	values[i++] = q^(0x58^0xFF);
	values[i++] = q^(0x98^0xFF);
	values[i++] = q^(0x68^0xFF);
	values[i++] = q^(0xA8^0xFF);
	values[i++] = q^(0xC8^0xFF);
	values[i++] = q^(0x70^0xFF);
	values[i++] = q^(0xB0^0xFF);
	values[i++] = q^(0xD0^0xFF);
	values[i++] = q^(0xE0^0xFF);
    } 
    if(r >= 6) {
    	values[i++] = q^(0x3^0xFF);
	values[i++] = q^(0x5^0xFF);
	values[i++] = q^(0x9^0xFF);
	values[i++] = q^(0x11^0xFF);
	values[i++] = q^(0x21^0xFF);
	values[i++] = q^(0x41^0xFF);
	values[i++] = q^(0x81^0xFF);
	values[i++] = q^(0x6^0xFF);
	values[i++] = q^(0xA^0xFF);
	values[i++] = q^(0x12^0xFF);
	values[i++] = q^(0x22^0xFF);
	values[i++] = q^(0x42^0xFF);
	values[i++] = q^(0x82^0xFF);
	values[i++] = q^(0xC^0xFF);
	values[i++] = q^(0x14^0xFF);
	values[i++] = q^(0x24^0xFF);
	values[i++] = q^(0x44^0xFF);
	values[i++] = q^(0x84^0xFF);
	values[i++] = q^(0x18^0xFF);
	values[i++] = q^(0x28^0xFF);
	values[i++] = q^(0x48^0xFF);
	values[i++] = q^(0x88^0xFF);
	values[i++] = q^(0x30^0xFF);
	values[i++] = q^(0x50^0xFF);
	values[i++] = q^(0x90^0xFF);
	values[i++] = q^(0x60^0xFF);
	values[i++] = q^(0xA0^0xFF);
	values[i++] = q^(0xC0^0xFF);
    } 
    if(r >= 7) {
    	values[i++] = q^(0x1^0xFF);
	values[i++] = q^(0x2^0xFF);
	values[i++] = q^(0x4^0xFF);
	values[i++] = q^(0x8^0xFF);
	values[i++] = q^(0x10^0xFF);
	values[i++] = q^(0x20^0xFF);
	values[i++] = q^(0x40^0xFF);
	values[i++] = q^(0x80^0xFF);
    } 
    if(r >= 8) {
    	values[i++] = q^0xFF;
    }
